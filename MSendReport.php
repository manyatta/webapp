...
global $connection;
$upload_path = 'mUploads/'; //this is our upload folder
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(isset($_POST['activity']) and isset($_FILES['image']['name']))
    {
        ...
        $query = "SELECT * FROM municiple_report WHERE activity='$activity'";
        ...
        try{
            ...
            $sql = "INSERT INTO municiple_report(photo_name, photo_url, activity, county, latitude, longitude) ";
...
function getFileName(){
    ...
    $sql = "SELECT max(report_id) as report_id FROM municiple_report";
